...
@section('content')
    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('partners_admin.drivers.store') }}" enctype="multipart/form-data" class="driver-form">
            @csrf
            ...
            <div class="button-container">
                <button type="submit" class="btn btn-primary mt-3 submit-btn">Send</button>
