    ...
    <div class="sidebar">
        ...
        <ul>
            ...
            <li class="">
                ...
                <a href="{{ route('staff_admin.dashboard') }}">Dashboard</a>
            </li>
            ...
            <li class="logout-item">
                <form action="{{ route('staff_admin.logout') }}" method="POST">
                    @csrf
        ...
        <nav class="navbar">
            ...
            <div class="navbar-right">
                <div class="admin-profile">
                    ...
                    @if(Auth::guard('staff_admin')->user()->profile_picture)
                        <img src="{{ asset(Auth::guard('staff_admin')->user()->profile_picture) }}" alt="Admin Profile"
                            class="profile-img">
                    @else
                        <i class="bx bx-user-circle profile-icon"></i>
                    @endif
                    <div class="admin-info">
                        <span class="admin-name">{{ Auth::guard('staff_admin')->user()->firstname }}
                            {{ Auth::guard('staff_admin')->user()->lastname }}</span><br>

                        <span class="admin-role">{{ Auth::guard('staff_admin')->user()->role }}</span>
