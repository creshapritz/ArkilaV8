    ...
    <div>
        ...
        <div class="reliable-content">
            ...
            <div class="suv-section">
                <div class="suv-text">
                    <h2>SUV Car</h2>
                    <p>Perfect for family trips and adventures, our SUVs offer spacious interiors, strong performance,
                        and a smooth ride—ready to conquer both city roads and off-road getaways.</p>
                    <button class="proceed-button"
                        onclick="window.location.href='{{ route('rent') }}'">Proceed</button>
                </div>
                <div class="suv-image">
                    <img src="assets/img/suv.png" alt="SUV Car">
                </div>
            </div>
            ...
            <div class="suv-section">
                <div class="suv-text1">
                    <h2>Small Car</h2>
                    <p>Need something compact and efficient? Our small cars are great for city driving, parking in tight
                        spaces, and saving on fuel—perfect for solo or couple travelers.</p>
                    <button class="proceed-button"
                        onclick="window.location.href='{{ route('rent') }}'">Proceed</button>
                </div>
                <div class="suv-image1">
                    <img src="assets/img/small_car.png" alt="Small Car">
                </div>
            </div>
            ...
            <div class="suv-section">
                <div class="suv-text1">
                    <h2>Large Car</h2>
                    <p>Experience extra comfort and room to stretch with our large sedans—ideal for longer road trips,
                        family outings, or business travel in style.</p>
                    <button class="proceed-button"
                        onclick="window.location.href='{{ route('rent') }}'">Proceed</button>
                </div>
                <div class="suv-image1">
                    <img src="assets/img/large_car.png" alt="Large Car">
                </div>
            </div>
            ...
            <div class="suv-section">
                <div class="suv-text1">
                    <h2>Mini Van Car</h2>
                    <p>Travel together with ease! Our vans are perfect for large groups or families, offering roomy
                        interiors, comfort, and convenience for long journeys.</p>
                    <button class="proceed-button"
                        onclick="window.location.href='{{ route('rent') }}'">Proceed</button>
                </div>
                <div class="suv-image1">
                    <img src="assets/img/minivan.png" alt="Mini Van Car">
                </div>
            </div>
