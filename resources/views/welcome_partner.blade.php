                ...
                <div class="text-container1">
                    ...
                    <div class="button-container">
                        <button class="partner-button"
                            onclick="window.open('{{ asset('documents/REQUIREMENTS_ARKILA.pdf') }}', '_blank')">
                            Requirements
                        </button>

                        <button class="partner-button" onclick="window.open('{{ asset('documents/PARTNERPROPOSALFORM_ARKILA.pdf') }}', '_blank')">Send Application</button>
                    </div>
                </div>
